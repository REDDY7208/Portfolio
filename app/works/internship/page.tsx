  ...
  return (
    <main className="min-h-screen pt-32 pb-20 px-8 md:px-12 relative overflow-x-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-orange-500/10 blur-[120px] rounded-full"></div>
        <div className="absolute bottom-0 left-0 w-1/3 h-1/3 bg-amber-500/10 blur-[100px] rounded-full"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <header className="mb-16">
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            Early <span className="text-primary italic">Career</span>.
          </h1>
          <p className="text-gray-400 max-w-2xl text-lg leading-relaxed">
            Hands-on learning and professional growth through internships,
            working alongside industry experts on real-world problems.
          </p>
        </header>
...
export default InternshipWorks;
